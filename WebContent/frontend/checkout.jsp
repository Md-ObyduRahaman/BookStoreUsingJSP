		...
		<c:if test="${cart.totalItems > 0}">			
				<div>
					...
					<table>
						<tr>
							<td>First Name:</td>
							<td><input type="text" name="firstname" value="${loggedCustomer.firstname}" required minlength="3" maxlength="30" /></td>
						</tr>
						<tr>
							<td>Last Name:</td>
							<td><input type="text" name="lastname" value="${loggedCustomer.lastname}" required minlength="3" maxlength="30" /></td>
						</tr>						
						<tr>
							<td>Phone:</td>
							<td><input type="text" name="phone" value="${loggedCustomer.phone}" required minlength="9" maxlength="15" /></td>
						</tr>
						<tr>
							<td>Address Line 1:</td>
							<td><input type="text" name="address1" value="${loggedCustomer.addressLine1}" required minlength="10" maxlength="256" /></td>
						</tr>
						<tr>
							<td>Address Line 2:</td>
							<td><input type="text" name="address2" value="${loggedCustomer.addressLine2}" required minlength="10" maxlength="256" /></td>
						</tr>						
						<tr>
							<td>City:</td>
							<td><input type="text" name="city" value="${loggedCustomer.city}" required minlength="3" maxlength="32" /></td>
						</tr>
						<tr>
							<td>State:</td>
							<td><input type="text" name="state" value="${loggedCustomer.state}" required minlength="3" maxlength="45" /></td>
						</tr>												
						<tr>
							<td>Zip Code:</td>
							<td><input type="text" name="zipcode" value="${loggedCustomer.zipcode}" required minlength="3" maxlength="24" /></td>
						</tr>						
						<tr>
							<td>Country:</td>
							<td>
